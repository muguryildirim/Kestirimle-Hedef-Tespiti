...
public class Sensor {
    ...
    public String toString() {
        ...
        sb.append(", positionX1='").append(positionX1).append('\'');
        sb.append(", positionY1='").append(positionY1).append('\'');
        sb.append(", bearingAngle1='").append(bearingAngle1).append('\'');
        sb.append(", name2='").append(name2).append('\'');
        sb.append(", positionX2='").append(positionX2).append('\'');
        sb.append(", positionY2='").append(positionY2).append('\'');
        sb.append(", bearingAngle2='").append(bearingAngle2).append('\'');
        sb.append('}');
        return sb.toString();
    }
}