...
public class Kafka {
    ...
    public ConsumerFactory<String, String> consumerFactory() {
        ...
        config.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "location:9092");
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, Sensor> sensorKafkaListenerFactory() {
